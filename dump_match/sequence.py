...
class Sequence(object):
    def __init__(self, dataset_path, dump_dir, desc_name, vis_th, pair_num, pair_name=None):
        self.data_path = os.path.normpath(dataset_path)
        ...
        img_list_file = os.path.join(self.data_path, "images.txt")
        geom_list_file = os.path.join(self.data_path, "calibration.txt")
        vis_list_file = os.path.join(self.data_path, "visibility.txt")
    ...
    def parse_list_file(self, data_path, list_file):
        ...
        with open(list_file, "r") as img_list:
            while True:
                ...
                fullpath_list += [os.path.join(data_path, line2parse.rstrip("\n"))]
