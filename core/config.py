...
net_arg.add_argument(
    ...
    "list of cluster reduction layers. Default: [3, 4]")
net_arg.add_argument(
...
loss_arg.add_argument(
    "--loss_essential", type=float, default=0.75, help=""
    "weight of the essential loss")
loss_arg.add_argument(
    "--loss_essential_init_iter", type=int, default=10000, help=""
...
loss_arg.add_argument(
    "--focal_alpha", type=float, default=0.25, help=""
    "alpha in focal prob loss")
...
# sun3d training
# train_arg.add_argument(
#     "--train_iter", type=int, default=700000, help=""
#     "training iterations to perform")
train_arg.add_argument(
    "--log_base", type=str, default="../model/", help=""
    "save directory name inside results")
train_arg.add_argument(
    "--log_suffix", type=str, default="mpsca", help=""
    "suffix of log dir")
train_arg.add_argument(
...
train_arg.add_argument(
    ...
    "summary interval")
train_arg.add_argument(
    "--save_late_snapshots", type=str2bool, default=True, help=""
    "save every validation snapshot after late_snapshot_start")
train_arg.add_argument(
    "--late_snapshot_start", type=int, default=400000, help=""
    "first iteration to save validation snapshots")
train_arg.add_argument(
...
test_arg.add_argument(
    ...
    "use RANSAC when validating; False uses the network weighted eight-point estimate. Default: False")
test_arg.add_argument(
